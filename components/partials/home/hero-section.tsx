...
export default function HeroSection() {
    return (
        <section className="container mx-auto min-h-screen flex flex-col items-center justify-center space-y-20">
            {/* title */}
            <div className="flex flex-col space-y-5 justify-center items-center">
                <h1 className="font-extrabold text-5xl text-center text-pretty leading-snug select-text">
